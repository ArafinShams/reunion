# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-04 14:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('payserial', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registrations.RegistrationAddress')),
            ],
        ),
        migrations.CreateModel(
